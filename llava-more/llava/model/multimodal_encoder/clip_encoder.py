...
class SigLIPVisionTower(nn.Module):
    def __init__(self, vision_tower, args, delay_load=False):
        ...
        if not delay_load:
            ...
            model = SiglipVisionModel.from_pretrained(self.vision_tower_name, token=_get_hf_token())
    ...
    def load_model(self, device_map=None):
        ...
        self.image_processor = SiglipImageProcessor.from_pretrained(self.vision_tower_name, token=_get_hf_token())
        self.vision_tower= SiglipVisionModel.from_pretrained(self.vision_tower_name, device_map=device_map, token=_get_hf_token())
...
class SigLIPVisionTowerS2(SigLIPVisionTower):
    ...
    def load_model(self, device_map=None):
        ...
        self.image_processor = CustomSiglipImageProcessor.from_pretrained(self.vision_tower_name, token=_get_hf_token())
        self.vision_tower= SiglipVisionModel.from_pretrained(self.vision_tower_name, device_map=device_map, token=_get_hf_token())
        self.vision_tower.requires_grad_(False)
...
class CLIPVisionTower(nn.Module):
    def __init__(self, vision_tower, args, delay_load=False):
        ...
        if not delay_load:
            ...
            self.cfg_only = CLIPVisionConfig.from_pretrained(self.vision_tower_name, token=_get_hf_token())
    ...
    def load_model(self, device_map=None):
        ...
        self.image_processor = CLIPImageProcessor.from_pretrained(self.vision_tower_name, token=_get_hf_token())
        self.vision_tower = CLIPVisionModel.from_pretrained(self.vision_tower_name, device_map=device_map, token=_get_hf_token())
        self.vision_tower.requires_grad_(False)
