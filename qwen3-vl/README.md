...
> **Note:** the paper configuration uses two MoDA cross-attention decoder layers (`--num-layers 2`, the script's built-in default), matching the released checkpoints; `scripts/train.sh` and `scripts/train_8b.sh` already set this.
